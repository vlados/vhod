<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Нов водомер</h1>
        ...
        <div class="mt-6 bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-md">
            <form wire:submit="saveWaterMeter">
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <!-- Начално показание -->
                        <div>
                            <label for="initial_reading" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Начално показание (м³)
                            </label>
                            <div class="mt-1">
                                <input type="number" step="0.001" wire:model="initial_reading" id="initial_reading" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md" placeholder="0.000">
                            </div>
